...
function pickIcon(icon) {
    ...
    switch (icon) { // switch statement to change background image for each weather type
        case "01d": //clear skys daytime
            $(".showcase").css("background-image", "url('https://petercr.github.io/Local-Weather-API/img/clearDay.jpg')"); /* Local-Weather-API/img/clearDay.jpg */
            $("#icons").html("<i class='wi wi-day-sunny'></i>");
            break;
        case "01n": // clear sky night
            $(".showcase").css("background-image", "url('https://petercr.github.io/Local-Weather-API/img/clearSkyNight.jpg')");
            $("#icons").html("<i class='wi wi-night-clear'></i>");
            break;
        case "02d": // few clouds day
            $(".showcase").css("background-image", "url('https://petercr.github.io/Local-Weather-API/img/fewCloudDay.jpg')");
            $("#icons").html("<i class='wi wi-day-cloudy'></i>");
            break;
        case "02n": // few clouds night
            $(".showcase").css("background-image", "url('https://petercr.github.io/Local-Weather-API/img/fewCloudsNight.jpg')");
            $("#icons").html("<i class='wi wi-night-cloudy'></i>");
            break;
        case "03d": // scattered clouds day
            $(".showcase").css("background-image", "url('https://petercr.github.io/Local-Weather-API/img/scatteredCloudsDay.jpg')");
            $("#icons").html("<i class='wi wi-day-sunny-overcast'></i>");
            break;
        case "03n": // scattered clouds night
            $(".showcase").css("background-image", "url('https://petercr.github.io/Local-Weather-API/img/scatteredCloudNight.jpg')");
        ...
        case "04n": // broken clouds night
            $(".showcase").css("background-image", "url('https://petercr.github.io/Local-Weather-API/img/scatteredCloudsNight.jpg')");
            $("#icons").html("<i class='wi wi-night-partly-cloudy'></i>");
            break;
        ...
        case "11d": // thunderstomrs
            $(".showcase").css("background-image", "url('https://petercr.github.io/Local-Weather-API/img/rainFloor.jpg')");
